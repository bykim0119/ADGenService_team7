        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "5. Prefer natural layered latte appearance, organic foam texture, and casual cafe photography realism.\n"
                    "6. Avoid perfect concentric patterns, perfect heart latte-art, overly graphic garnish placement, and overly uniform horizontal layers.\n"
                    "7. Do NOT mention text overlay, captions, typography, letters, logo placement, poster layout, banners, or watermarks.\n"
                    "8. Prefer concrete visual details: subject, action, camera framing, composition, lighting, mood, style.\n"
                    "9. Put subject and composition first, then lighting and mood, then style keywords last.\n"
                    "10. Focus on one clear scene and avoid vague filler words.\n\n"
